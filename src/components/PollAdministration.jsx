...
// Mock data for user's created polls
const mockUserPolls = [
  {
    id: 1,
    ...
    totalResponses: 0,
    totalFunding: "0.0 TON",
    targetFunding: "1.5 TON",
    fundingProgress: 0,
    rewardPool: "0.0 TON",
    duration: "7 days",
    expiresAt: "2025-07-17",
    options: ["JavaScript", "Python", "Java", "C++"],
    gaslessEnabled: true
  },
  {
    id: 2,
    title: "Should we implement dark mode in our app?",
    description: "User experience research to determine the demand for dark mode implementation.",
    status: "funding",
    category: "design",
    createdAt: "1 day ago",
    totalResponses: 5,
    totalFunding: "0.8 TON",
    targetFunding: "2.0 TON",
    fundingProgress: 40,
    rewardPool: "0.5 TON",
    duration: "5 days",
    expiresAt: "2025-07-15",
    options: ["Yes, definitely", "No, not needed", "Maybe later", "Don't care"],
    gaslessEnabled: true
  },
  {
    id: 3,
    title: "Best framework for web development in 2024?",
    description: "Community poll to understand the most preferred web development frameworks.",
    status: "active",
    category: "technology",
    createdAt: "3 days ago",
    totalResponses: 42,
    totalFunding: "3.0 TON",
  ...
  },
  {
    ...
    description: "Understanding how work preferences have changed after the pandemic experience.",
    status: "closed",
    category: "business",
    createdAt: "2 weeks ago",
    totalResponses: 128,
    totalFunding: "5.0 TON",
    targetFunding: "5.0 TON",
    fundingProgress: 100,
    rewardPool: "3.2 TON",
    duration: "Ended",
    expiresAt: "2025-07-01",
    options: ["Fully remote", "Hybrid", "Office-based", "Flexible"],
    gaslessEnabled: true
  }
];
