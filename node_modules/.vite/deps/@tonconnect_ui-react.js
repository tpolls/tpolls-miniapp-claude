...
var tonConnectSdkVersion = "3.2.0";
var TonConnect = class {
  ...
  signData(data, options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const response = yield this.provider.sendRequest(signDataParser.convertToRpcRequest(Object.assign(Object.assign({}, data), {
        from,
        network
          ...
          return [createComponent(Match, {
            ...
            get children() {
              return [createComponent(Spacer, {}), createComponent(ErrorIconStyled, {
                ...
                get children() {
                  return [createMemo(() => currentWalletName()), " doesn’t support the requested action"];
                }
